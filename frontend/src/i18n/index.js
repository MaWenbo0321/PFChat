...
const zhCN = {
    ...
    setup: {
        ...
        feedbackPeriodic: '完整对话',
        feedbackPeriodicDesc: '随时手动结束，或10分钟后自动结束，对话结束后生成语用分析报告',
        feedbackSummary: '五轮对话',
        feedbackSummaryDesc: '完成5轮对话后自动结束并生成语用分析报告',
        startBtn: '开始对话',
        logout: '退出登录',
    ...
    feedback: {
        periodicTitle: '阶段性语用反馈',
        periodicRound: '已完成 {count} 轮对话',
...
const enUS = {
    ...
    setup: {
        ...
        feedbackPeriodic: 'Complete Conversation',
        feedbackPeriodicDesc: 'End manually anytime or automatically after 10 minutes; analysis report generated at end',
        feedbackSummary: '5 Rounds',
        feedbackSummaryDesc: 'Automatically ends after 5 rounds and generates a pragmatic analysis report',
    ...
    feedback: {
        periodicTitle: 'Periodic Pragmatic Feedback',
        periodicRound: '{count} rounds completed',
